...
import com.maksboss800.activities.NewNoteActivity
import com.maksboss800.databinding.FragmentNoteBinding
import com.maksboss800.db.MainViewModel
import com.maksboss800.db.NoteAdapter
    ...
    private fun onEditResult(){
        ...
        editLauncher=registerForActivityResult(ActivityResultContracts.StartActivityForResult()){
            if(it.resultCode==Activity.RESULT_OK){
                val edit_state=it.data?.getStringExtra(EDIT_STATE_KEY)
                if(edit_state=="update"){
